...
func evaluate_state(state: Dictionary) -> void:
	...
	var later_stages := ["chapter2_complete", "huashan_meet_companion", "huashan_trial", "huashan_trial_complete", "chapter3_complete", "emei_meet_su", "emei_investigate", "emei_trial"]
	...
	if stage == "emei_trial": unlock("ACH_EMEI_GUEST")
