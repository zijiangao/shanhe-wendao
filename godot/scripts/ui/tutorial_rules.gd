...
static func content(step: String, objective: String) -> Dictionary:
	match step:
		"map":
			return {
				"title": "初入江湖 · 天下舆图",
				"body": "当前目标：%s\n\n选择目的地即可免费旅行。每周可进行一次修炼、采集、制作或战斗；完成后点击“结束本周”推进时间，并恢复气血与真气。右上角可查看剩余时间。" % objective
			}
		"location":
			return {
				"title": "场景行动",
		...
		"battle":
			return {
				"title": "战棋入门",
				"body": "身法决定出手顺序，顶部行动条显示当前与后续出手者。沈羽和同伴各自在自己的回合获得2点行动点。\n\n1. 选择“移动”后点击蓝色格位。\n2. 选择攻击或武学，再点击高亮敌人。\n3. 留意“敌方预判”；行动点用尽会自动推进，也可点击“结束回合”放弃剩余行动点。\n\n战败后可从战斗开始处重试。"
			}
		"sparring":
			return {
